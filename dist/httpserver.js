...
const block_candidate_1 = require("./models/block-candidate");
/**
...
class HttpServer {
    ...
    constructor(blockchain, p2p) {
         ...
         */
        this.about = "2020/KingslandUniChain/typescript/Bethany Osueke,Denis Putnam,Olivier Riccini";
    ...
    initHttpServer(myHttpPort) {
        ...
        app.get('/blocks/:index', (req, res) => {
            ...
            let rVal = this.blockchain.getBlockchain()[req.params.index];
            if (rVal == null) {
        ...
        app.get('/transactions/pending', (req, res) => {
            ...
            let rVal = this.blockchain.getPendingTransactions();
            res.send(rVal);
        });
        app.get('/transactions/confirmed', (req, res) => {
            console.log(this.myHttpPort + ':GET /transactions/confirmed');
            let rVal = this.blockchain.getConfirmedTransactions();
            res.send(rVal);
        });
        app.get('/transactions/:tranHash', (req, res) => {
            console.log(this.myHttpPort + ':GET /transactions/:' + req.params.tranHash);
            let rVal = this.blockchain.getTransactionsByTxHash(req.params.tranHash);
            if (rVal !== null) {
                res.send(rVal);
            }
            else {
        ...
        app.get('/balances', (req, res) => {
            ...
            // TODO fake for now.
            let rVal = this.blockchain.getBalances();
            if (rVal !== null) {
                res.send(rVal);
            }
            else {
        ...
        app.get('/address/:address/transactions', (req, res) => {
            ...
            let rVal = this.blockchain.getTransactions(req.params.address);
            if (rVal !== null) {
                res.send(rVal);
            }
            else {
        ...
        app.get('/address/:address/balance', (req, res) => {
            ...
            let rVal = this.blockchain.getAccountBalance(req.params.address);
            if (rVal !== null) {
                res.send(rVal);
            }
            else {
        ...
        app.post('/transactions/send', (req, res) => {
            ...
            */
            ...
            let validation = this.blockchain.validateReceivedTransaction(transaction);
        ...
        app.get('/mining/get-mining-job/:address', (req, res) => {
            ...
            if (this.blockchain.getTransactionPool().length > 0) {
                let newCandidateBlock = this.blockchain.createCandidateMinerBlock(req.params.address);
                ...
                let toMinerBlock = new block_candidate_1.BlockCandidate();
        ...
        app.post('/mining/submit-mined-block', (req, res) => {
             ...
             */
            let candidateBlock = this.blockchain.getMiningRequestMap().get(req.body.blockDataHash);
            if (candidateBlock == undefined || candidateBlock.blockDataHash === undefined) {
                ...
                if (verified) {
                    ...
                    let _success = this.blockchain.addBlockToChain(candidateBlock);
